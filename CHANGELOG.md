...
## [2.1.2+1.21.11](https://github.com/rradillen/minecord/compare/v2.1.2+1.21.11...v2.1.2+1.21.11) (2026-07-14)
...
* **chat:** entity names with special characters should not cause a crash (closes [#165](https://github.com/rradillen/minecord/issues/165)) ([ecab6a5](https://github.com/rradillen/minecord/commit/ecab6a5b21dcc6de8852cf886488cea0cbde9193))
...
* **chat:** respawning should not send a `teleport` message (closes [#171](https://github.com/rradillen/minecord/issues/171)) ([#173](https://github.com/rradillen/minecord/issues/173)) ([4df14c4](https://github.com/rradillen/minecord/commit/4df14c42a935f415235a6a596ff21a726b224051))
...
* add support for Minecraft 1.21.11+ ([8798072](https://github.com/rradillen/minecord/commit/879807223094386ef9c641a835385beac8d024c9))
* add support for Minecraft 1.21.3+ ([#157](https://github.com/rradillen/minecord/issues/157)) ([767e478](https://github.com/rradillen/minecord/commit/767e478d804e45a7e60525822152ba7d1ac9e292))
* add support for Minecraft 1.21.5+ ([e0deca4](https://github.com/rradillen/minecord/commit/e0deca4d961aaa19ee2ddb5a08c63f877b573755))
* add support for Minecraft 1.21.6+ ([4adb1b6](https://github.com/rradillen/minecord/commit/4adb1b676afa9396723a93762575093b3767bf1b))
* add support for Minecraft 1.21.7+ ([b869e50](https://github.com/rradillen/minecord/commit/b869e50870a1ed5bad68d80a57da30bed3016c07))
* add support for Minecraft 1.21.9+ ([de2d883](https://github.com/rradillen/minecord/commit/de2d883423f2341e4d03fc2bebe8bde4d11ba365))
...
* **api:** add support for Minecraft 1.21.11+ ([7d9c77b](https://github.com/rradillen/minecord/commit/7d9c77b7c09e66bdec883018c24382df227eed0d))
...
* **api:** add support for Minecraft 1.21.5+ ([63c460a](https://github.com/rradillen/minecord/commit/63c460a881d0c6720262003a59c2be673a8f7f6e))
* **api:** add support for Minecraft 1.21.6+ ([d297e19](https://github.com/rradillen/minecord/commit/d297e19e62a1b66a2a48aaec188985bad7ecf097))
* **api:** add support for Minecraft 1.21.7+ ([428f1d9](https://github.com/rradillen/minecord/commit/428f1d957fd986673298316ff8b0478cd134bb37))
* **api:** add support for Minecraft 1.21.9+ ([4b47992](https://github.com/rradillen/minecord/commit/4b47992b0aaa7bd04b650821cd941ef747976504))
...
* **chat:** add support for Minecraft 1.21.11+ ([2d66088](https://github.com/rradillen/minecord/commit/2d66088d8e681cea082a316048bdd31eaf06ac9d))
* **chat:** add support for Minecraft 1.21.3+ ([#160](https://github.com/rradillen/minecord/issues/160)) ([bcf84f9](https://github.com/rradillen/minecord/commit/bcf84f918b32a87361b625a1f793f2143f8dd913))
* **chat:** add support for Minecraft 1.21.5+ ([a07025d](https://github.com/rradillen/minecord/commit/a07025d869c36f5cb53aeb823b432135b2f2b9b1))
* **chat:** add support for Minecraft 1.21.6+ ([7a82dcc](https://github.com/rradillen/minecord/commit/7a82dcc754c095412a15c7654400840fa93092ef))
* **chat:** add support for Minecraft 1.21.7+ ([be5ed57](https://github.com/rradillen/minecord/commit/be5ed577001d0e026536e46405483739a199282c))
* **chat:** add support for Minecraft 1.21.9+ ([9e77f5b](https://github.com/rradillen/minecord/commit/9e77f5ba48fee7f0bb04984e7e38a1309b4ba1b0))
...
* **cmds:** add support for Minecraft 1.21.11+ ([7c1cf4d](https://github.com/rradillen/minecord/commit/7c1cf4de724fee0d4a2a4da35b403158be01d24e))
* **cmds:** add support for Minecraft 1.21.3+ ([#161](https://github.com/rradillen/minecord/issues/161)) ([f7acdd6](https://github.com/rradillen/minecord/commit/f7acdd6cbf2ea319baff5aca417aa5e5d58f8095))
* **cmds:** add support for Minecraft 1.21.5+ ([2c851a7](https://github.com/rradillen/minecord/commit/2c851a713786ee96735944218f1a3b56f15356dd))
* **cmds:** add support for Minecraft 1.21.6+ ([6271d7c](https://github.com/rradillen/minecord/commit/6271d7c8672855052706e9bbbe4e53b99f23c6af))
* **cmds:** add support for Minecraft 1.21.7+ ([75b110f](https://github.com/rradillen/minecord/commit/75b110fc68f0c33cdb44c72c27ab77fffdc5f0dc))
* **cmds:** add support for Minecraft 1.21.9+ ([5bcf922](https://github.com/rradillen/minecord/commit/5bcf9221a5442633b83ebc719d6f21d064a1d98d))
...
* **presence:** add support for Minecraft 1.21.11+ ([39b052e](https://github.com/rradillen/minecord/commit/39b052e3aa557d18e30c24004c87ee548a5cff16))
* **presence:** add support for Minecraft 1.21.3+ ([#162](https://github.com/rradillen/minecord/issues/162)) ([9baea0e](https://github.com/rradillen/minecord/commit/9baea0e175f2218c4417be9d56ee40f69fab188a))
* **presence:** add support for Minecraft 1.21.5+ ([2d19671](https://github.com/rradillen/minecord/commit/2d19671ad88f6deec973e43370460f303aeb53fa))
* **presence:** add support for Minecraft 1.21.6+ ([c4ab42f](https://github.com/rradillen/minecord/commit/c4ab42f4e2dfeb5cabd9b901a54d98fe8fe30303))
* **presence:** add support for Minecraft 1.21.7+ ([5624a6c](https://github.com/rradillen/minecord/commit/5624a6c429f4093ead370f988df5665eae30a86d))
* **presence:** add support for Minecraft 1.21.9+ ([2645faf](https://github.com/rradillen/minecord/commit/2645faf0d775e7cdc78d14ce1224c4a39dcb0464))
